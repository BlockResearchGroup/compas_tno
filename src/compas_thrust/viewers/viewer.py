...
from compas_thrust.viewers.core import Camera
from compas_thrust.viewers.core import Mouse
from compas_thrust.viewers.core import Grid
from compas_thrust.viewers.core import Axes
from compas_thrust.viewers.core import GLWidget
from compas_thrust.viewers.core import Controller
from compas_thrust.viewers.core import App
...
class Front(Controller):
    ...
    settings['edge.qind:value'] = 100.0
    settings['edge.qind:minval'] = 50.0
    settings['edges.qind:maxval'] = 150.0
    settings['edges.qind:step'] = 1
    settings['edges.qind:scale'] = 1.0
