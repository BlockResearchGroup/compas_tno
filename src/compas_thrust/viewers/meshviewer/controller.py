...
from compas_thrust.viewers import core
from compas_thrust.viewers.meshviewer.model import MeshView
...
class Controller(core.controller.Controller):
    ...
    settings['edge.qind:value'] = 1.0
    settings['edge.qind:minval'] = 0.0
    settings['edge.qind:maxval'] = 10000.0
    settings['edge.qind:step'] = 0.01
    settings['edge.qind:scale'] = 0.01

    settings['edge.qi:value'] = 0
    settings['edge.qi:minval'] = 0
    settings['edge.qi:maxval'] = 10
    settings['edge.qi:step'] = 1
    settings['edge.qi:scale'] = 1
    ...
    def slide_qind_edge(self, value):
        self.settings['edge.qind:value'] = value
        self.form_from_qid(self.settings['edge.qind:value'], self.settings['edge.qi:value'])

    def edit_qind_edge(self, value):
        self.settings['edge.qind:value'] = value
        self.form_from_qid(self.settings['edge.qind:value'], self.settings['edge.qi:value'])

    def slide_ind_edge(self, value):
        self.settings['edge.qi:value'] = value
        self.form_from_qid(self.settings['edge.qind:value'], self.settings['edge.qi:value'])

    def edit_ind_edge(self, value):
        self.settings['edge.qi:value'] = value
        self.form_from_qid(self.settings['edge.qind:value'], self.settings['edge.qi:value'])
    ...
    def form_from_qid(self, qid=1.0, ind_i = 0):
        self.mesh = update_qid('/Users/mricardo/compas_dev/me/loadpath/jeronimos/jeronimos_complete.json', qid, ind_i)
        self.view.glInit()
        self.view.make_buffers()
        self.view.updateGL()
        self.app.main.activateWindow()
