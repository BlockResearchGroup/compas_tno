...
def apply_envelope_from_shape(form, shape):
    ...
    if shape.datashape["type"] == "dome":
        ...
        zub, zlb = pointed_vault_ub_lb_update(
            x, y, shape.datashape["thk"], shape.datashape["t"], shape.datashape["xy_span"], hc=shape.datashape["hc"], he=shape.datashape["he"], hm=shape.datashape["hm"]
        )
...
def apply_bounds_on_q(form, qmin=-1e4, qmax=1e-8):
