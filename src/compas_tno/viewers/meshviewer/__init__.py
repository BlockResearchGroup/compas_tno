                ...
                },
                {
                    ...
                    'items': [
                        ...
                        },
                        {
                            'type'   : 'slider',
                            'text'   : 'qind',
                            'value'  : Controller.settings['edge.qind:value'],
                            'minval' : Controller.settings['edge.qind:minval'],
                            'maxval' : Controller.settings['edge.qind:maxval'],
                            'step'   : Controller.settings['edge.qind:step'],
                            'scale'  : Controller.settings['edge.qind:scale'],
                            'slide'  : 'slide_qind_edge',
                            'edit'   : 'edit_qind_edge',
                        },
                        {
                            'type'   : 'slider',
                            'text'   : 'i',
                            'value'  : Controller.settings['edge.qi:value'],
                            'minval' : Controller.settings['edge.qi:minval'],
                            'maxval' : Controller.settings['edge.qi:maxval'],
                            'step'   : Controller.settings['edge.qi:step'],
                            'scale'  : Controller.settings['edge.qi:scale'],
                            'slide'  : 'slide_ind_edge',
                            'edit'   : 'edit_ind_edge',
                        }
                    ]
                }
