...
def crossvault_dub_dlb_old(x, y, thk, t, xy_span=[[0.0, 10.0], [0.0, 10.0]], tol=1e-6):  # Only for Square Cross Vault !!
...
# def cross_vault_highfields_old(xy_span=[[0.0, 10.0], [0.0, 10.0]], thk=None, tol=10e-6, t=10.0, discretisation=[100, 100], expanded=False):
#     """ Set Cross-Vault heights.
...
#     if ry > rx:
#         y1 = xy_span[1][1] + thk/2 * rx/ry
#         y0 = xy_span[1][0] - thk/2 * rx/ry
#         x1 = xy_span[0][1] + thk/2
#         x0 = xy_span[0][0] - thk/2
#     else:
#         y1 = xy_span[1][1] + thk/2
#         y0 = xy_span[1][0] - thk/2
#         x1 = xy_span[0][1] + thk/2 * ry/rx
#         x0 = xy_span[0][0] - thk/2 * ry/rx
