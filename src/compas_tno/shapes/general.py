...
def general_ub_lb_update_with_n(ub, lb, n, intrados, extrados):  # n represents the magnitude of the normal vector
...
def general_dub_dlb_with_n(ub, lb, n, intrados, extrados):
