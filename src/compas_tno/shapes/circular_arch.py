...
def arch_shape(H=1.00, L=2.0, x0=0.0, thk=0.20, b=0.5, t=0.0, total_nodes=100):
    ...
    intrados = MeshDos.from_vertices_and_faces(array([xs, ys, zis]).transpose(), faces)
    extrados = MeshDos.from_vertices_and_faces(array([xs, ys, zes]).transpose(), faces)
    middle = MeshDos.from_vertices_and_faces(array([xs, ys, zts]).transpose(), faces)
...
def arch_shape_polar(H=1.00, L=2.0, x0=0.0, thk=0.20, b=0.5, total_nodes=100):
    ...
    intrados = MeshDos.from_vertices_and_faces(array([xis, ys, zis]).transpose(), faces)
    extrados = MeshDos.from_vertices_and_faces(array([xes, ys, zes]).transpose(), faces)
    middle = MeshDos.from_vertices_and_faces(array([xts, ys, zts]).transpose(), faces)
