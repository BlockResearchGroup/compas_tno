...
def pointed_arch_shape(H=1.00, L=2.0, x0=0.0, thk=0.20, b=0.5, t=5.0, total_nodes=100):
...
def pointed_arch_ub_lb_update(x, y, thk, t, H=1.00, L=2.0, x0=0.0):
...
def pointed_arch_dub_dlb(x, y, thk, t, H=1.00, L=2.0, x0=0.0):
