            ...
            'items' : [
                {
                    ...
                    'items' : [
                        ...
                        {'type': 'checkbox', 'text': 'friction', 'action': 'toggle_friction', 'state': Controller.settings['friction.on'], },
                        {'type': 'checkbox', 'text': 'mass_opt', 'action': 'toggle_massopt', 'state': Controller.settings['massopt.on'], },
                    ]
                },
            ]
        },
                    ...
                    'items': [
                        {
                            'type'   : 'slider',
                            'text'   : 'mu',
                            'value'  : Controller.settings['mu:value'],
                            'minval' : Controller.settings['mu:minval'],
                            'maxval' : Controller.settings['mu:maxval'],
                            'step'   : Controller.settings['mu:step'],
                            'scale'  : Controller.settings['mu:scale'],
                            'slide'  : 'slide_mu',
                            'edit'   : 'edit_mu',
                        },
                        {
                            'type'   : 'slider',
                            'text'   : 'cm',
                            'value'  : Controller.settings['cm:value'],
                            'minval' : Controller.settings['cm:minval'],
                            'maxval' : Controller.settings['cm:maxval'],
                            'step'   : Controller.settings['cm:step'],
                            'scale'  : Controller.settings['cm:scale'],
                            'slide'  : 'slide_cm',
                            'edit'   : 'edit_cm',
                        },
                        {
                            'type'   : 'slider',
                            'text'   : 'delta',
                            'value'  : Controller.settings['delta:value'],
                            'minval' : Controller.settings['delta:minval'],
                            'maxval' : Controller.settings['delta:maxval'],
                            'step'   : Controller.settings['delta:step'],
                            'scale'  : Controller.settings['delta:scale'],
                            'slide'  : 'slide_delta',
                            'edit'   : 'edit_delta',
                        },
                    ]
