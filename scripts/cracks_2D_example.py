...
if __name__ == "__main__":
    ...
    file_save = '/Users/mricardo/compas_dev/me/minmax/2D_Arch/cracks.json'
    blocks = 20
    thk = 0.20
    ...
    while exitflag == 0:
        ...
        while count < 100 and exitflag is not 0:
            ...
            if qmin > -0.1 and exitflag == 0:
                ...
                plot_form_xz(form, radius=0.02, cracks=True, simple=True, fix_width = True, max_width=1.5, heights=True, show_q=False, thk = thk, plot_reactions=True).show()
