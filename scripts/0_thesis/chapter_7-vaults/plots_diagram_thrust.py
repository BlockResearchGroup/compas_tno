...
thks['6.1147'] = [0.05, 0.045, 0.04, 0.035, 0.03, 0.025, 0.02, 0.015, 0.0138581687892141]
mins['6.1147'] = [0.696302181430962, 0.712190170707322, 0.728715423421778, 0.746097517580299, 0.765045434280777, 0.785257690737793, 0.806267884905145, 0.83196507678578, 0.836965223876471]
maxs['6.1147'] = [-1.00891403607344, -0.983829961062245, -0.959678524921317, -0.936004852009428, -0.91283679868865, -0.890979621242108, -0.869560153457901, -0.846864654473703, -0.836965223876471]

thks['7.08'] = [0.05, 0.045, 0.04, 0.035, 0.03, 0.025, 0.02, 0.0180566482731426]
mins['7.08'] = [0.622129590045542, 0.635886376449303, 0.650113852193332, 0.665025993190104, 0.680726634985757, 0.697321111094259, 0.720838836706226, 0.754437107668423]
maxs['7.08'] = [-0.874918142130951, -0.855463033424789, -0.836654226378205, -0.818451721428526, -0.800817948896633, -0.783702346353567, -0.766800192517039, -0.754437107668423]

thks['7.9422'] = [0.05, 0.045, 0.04, 0.035, 0.03, 0.025, 0.0210616141712768]
mins['7.9422'] = [0.574844815391402, 0.587220045811639, 0.600260450626909, 0.613819594404171, 0.628155133426835, 0.653045545746104, 0.704111404462089]
maxs['7.9422'] = [-0.793821830005611, -0.777418630549045, -0.761524986455031, -0.746111584081397, -0.731150795765791, -0.716616504228468, -0.704111404462089]

legends.append(r'parametric | $\beta=20$')
colors.append('C3')
...
for R in Rs:
    ...
    thicknesses_all.append([thks[str(R)], thks[str(R)]])
    solutions_all.append([mins[str(R)], maxs[str(R)]])
