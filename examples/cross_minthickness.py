...
if __name__ == "__main__":
    ...
    FILECSV = '/Users/mricardo/compas_dev/me/minmax/cross/rectangular/5x10/minthck_via_' + objective + '_' + type_fd + '.csv'
    ...
    with open(FILECSV, 'w', newline='') as file:
        ...
        writer.writerow([thck*100, rx, ry, max(q), zb, fopt, exitflag])
