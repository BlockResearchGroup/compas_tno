...
for i in ['B1','B2','B3','C1','C2','C3','C4','C5','D1','D2','D3','D4','D5']:
    jsonpath = '/Users/mricardo/compas_dev/me/loadpath/Fix/topology/'+i+'_complete.json'

    # Form

    Mesh = 'Topology::'+ i #_0' + str(j) #_complete '0' + str(j) + '_0' + str(i)
    ...
    for msh in rs.ObjectsByLayer(Mesh):
        if rs.IsMesh(msh):
            mesh = msh
    ...
    form = FormDiagram.from_rhinomesh(mesh)
    ...
    loads = FormDiagram.from_rhinomesh(mesh)
    pzt = 0
