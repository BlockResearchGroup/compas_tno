...
target_x = L/2  # Want to get the vertex having x = L/2 (midspan) / try L/4
...
plotter = MeshPlotter(form, figsize=(10,5))
plotter.draw_edges()
...
# --------------- 6 . After exit print the list of solutions an do plots ------------
