...
phi_list = [0.0, 22.5, 45, 67.5, 90.0]  # [-22.5, -45, -67.5]
...
for phi, sign in phi_pair:
    ...
    for obj in objective:  # set the objective
        ...
        for thk in [0.50]:  # thickness of the problem # [0.50, 0.45, 0.40, 0.35, 0.336]
            ...
            address = save_form + '_' + objective[0] + '_thk_' + str(100*thk) + '.json'

            form = FormDiagram.from_json(address)

            view = Viewer(form, vault, show_grid=False)
            ...
            if corner:
                ...
                # view.save(path='/Users/mricardo/compas_dev/compas_tno/data/img-{}.png'.format(i))
                view.show()
