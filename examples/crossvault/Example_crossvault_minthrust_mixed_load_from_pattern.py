...
type_formdiagram_load = 'cross_fd'
discretisation = 10
...
plot_form(form_load, show_q=False, fix_width=True).show()
...
analysis.apply_selfweight_from_pattern(form_load, plot=True)
