...
if __name__ == "__main__":
    ...
    for j in [2]: # j = 1
        ...
        for i in shapes: # j = 2
            ...
            # file = '/Users/mricardo/compas_dev/me/bestfit/pavillionvault/discretize/0'+str(j)+'_0'+str(i)+'_complete.json'
            file_save = '/Users/mricardo/compas_dev/me/bestfit/sixpartite/discretize/0'+str(j)+'_0'+str(i)+'_fit_sixpartite.json'
            file_complete = '/Users/mricardo/compas_dev/me/bestfit/sixpartite/discretize/0'+str(j)+'_0'+str(i)+'_complete.json'
            ...
            # form = create_sym(form, keep_q= False)
