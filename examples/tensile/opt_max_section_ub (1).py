...
# # from compas_tno.plotters import _draw_lines_arch
# # lines_arch = _draw_lines_arch(vault)

# lines = []

# for u, v in form.edges():
#     xa, ya, za = form.vertex_coordinates(u)
#     xb, yb, zb = form.vertex_coordinates(v)
...
plot_form_xz(form, vault, radius=0.01).show()
