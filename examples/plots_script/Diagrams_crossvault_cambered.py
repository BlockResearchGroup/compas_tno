...
print(GSF)
print(RS)
GSF_file = os.path.join('/Users/mricardo/compas_dev/me', 'shape_comparison', type_structure, 'GSF_plot_camb_' + str(type_formdiagrams) + '.pdf')
GSF_plot(RS, GSF, GSF_Legends, markers, colors_list, save=GSF_file)

diagram_file = os.path.join('/Users/mricardo/compas_dev/me', 'shape_comparison', type_structure, 'diagram_GSF_camb_'+ str(type_formdiagrams) +'.pdf')
