...
if __name__ == "__main__":
    ...
    file_save = '/Users/mricardo/Documents/ETH/Conferences/SAHC2020/My Paper/pictures/Figure_2_2.pdf'
    ...
    ax1 = plt.axes()
    ax2 = ax1.twiny()
    ax2.set_xticks([      0,     31.02,     49.70,  62.5,  75.00,  83.33,   93.75,  100])
    ax2.set_xticklabels(['1.0',   '1.33',  '1.66', '2.0',  '2.5',  '3.0',  '4.0',  '5.0'], size=size_axis_data)
