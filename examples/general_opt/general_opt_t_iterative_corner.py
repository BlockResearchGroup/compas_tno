...
for c in [0.25]:
    ...
    for obj in ['t']:
        ...
        for thk in [thk0]:
            ...
            while max(entropy, entropypz) > 10e-4 or i < 3:
                ...
                address = save_form + '_' + optimiser.settings['objective'] + '_thk_' + str(100*min_thk) + '.json'

                solutions[c][obj][thk] = thrust/weight * 100
                img_file = save_form + '_' + optimiser.settings['objective'] + '_thk_' + str(100*min_thk) + '.png'
                ...
                for key in form.vertices():
                    ...
                    form.vertex_attribute(key, 'pz', pz*factor)
                ...
                for el in gfinal:
                    if el < 0:
                        constr_error += el**2
                print('Min thk:', min_thk)
                print('Error observed:', constr_error)
                min_thks.append(min_thk)
...
if plot_comparison:
    ...
    ln2 = ax2.plot(xaxis2, entropies, label='hor. movement', color='C2')
