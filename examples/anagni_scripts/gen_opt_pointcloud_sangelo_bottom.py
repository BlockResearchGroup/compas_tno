...
file_formdiagram = os.path.join(folder, 'bottom_vault_formdiagram.json')
...
file_name = 'bottom_vault'  # This point cloud considers the extrados with 25 cm only
...
file_solution = os.path.join(folder, file_name + '_form_' + objective + '.json')
form.to_json(file_solution)

file_shape = os.path.join(folder, file_name + '_shape_' + objective + '.json')
